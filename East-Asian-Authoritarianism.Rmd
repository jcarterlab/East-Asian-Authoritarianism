...
1.4: Re-election rates for leaders. Note that China and Vietnam are not democratic while South Korea's constitution does not allow for re-election ([see here for details](Re-election_rates.xls)). 
```{r, echo = FALSE, message = FALSE, warning = FALSE, dpi=600}
