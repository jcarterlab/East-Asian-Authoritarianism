...
There is significantly lower net sentiment among Sinosphere users for each anti-authority term.
...
The data above show only the overall sentiment of tweets containing, or in response to those containing, anti-authority terms. They do not tell us anything about the context in which the terms were used. Athough the high number of tweets would suggest a more positive disposition to such terms among Anglosphere users, a more targeted study on individual protest events would be needed to confirm this. 
...
The countries were selected because Anglosphere and Sinosphere based cultures were thought to be the most different in terms of attitudes towards authority based on Hoefstede's research into power distance.
