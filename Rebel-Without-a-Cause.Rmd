...
Net sentiment is calculated as the total share of positive minus negative words. It is expressed as a percentage of all words by region and other relevant faceting variables, taking into account differences in the number and length of tweets.
