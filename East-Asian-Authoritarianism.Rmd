...
may_01_21 <- read_data("01-05-2021.csv", april_24_21)
...
This report analyzes attitudes towards individual liberty  between Sinic and Anglophone countries. It finds that Sinic country Twitter users demonstrate less positive sentiment when using freedom and a collection of anti-authority words. This may be due to the differing influence of Confucian verses European enlightenment values. 

It could also however be the result of a difference in context. Many people in Hong Kong and Taiwan for instance likely tweet negatively about their own freedoms given China's growing regional assertiveness. South East Asian countries such as Singapore may also be more likely to tweet negatively about the tragic loss of freedom in neighboring Myanmar following a recent military coup. 
...
1.3: Power distance scores, the extent to which people accept unequal power in society *(Hofstede, 1980)*.
...
The analysis collects tweets from within a 50 mile range of respective country capitals. A sentiment analysis is then conducted using the NRC library. This is done by calculating how often words associated with certain sentiments occur relative to their regional total. The data are collected weekly from the 10th of April until present. 
...
macro_stats <- combined_raw_data %>%
  ...
  mutate("Tweets (%)" = Tweets / (total_tweets) * 10^5,
...
2.1: The net sentiment for freedom, calculated as positive minus negative words. 
...
2.3: The net sentiment for anti-authority words, including variations of protest, rebel, revolt and riot. 
