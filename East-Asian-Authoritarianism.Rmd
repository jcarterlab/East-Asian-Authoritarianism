...
Yet given how a large portion of Sinic country Twitter users heavily criticize the recent military coup in neighboring Myanmar, these findings could also represent a greater use of hyperbolic language between increasingly split pro-hierarchy and pro-democracy groups in the Sino world.
...
Tweets are collected within 50 miles of the Anglophone (the US, the UK, Canada, Australia, New Zealand and South Africa) and Sinic (China, Vietnam, Taiwan, South Korea, Hong Kong and Singapore) country capitals from the 11th of May 2021 to present. A sentiment analysis is then conducted using the NRC sentiment library.
